...
type Querier interface {
	...
	GetFolderByUserAndName(ctx context.Context, arg GetFolderByUserAndNameParams) (Folder, error)
	GetOneUniqueCard(ctx context.Context, arg GetOneUniqueCardParams) (uuid.UUID, error)
	GetOneUniqueCardTheList(ctx context.Context, arg GetOneUniqueCardTheListParams) (uuid.UUID, error)
